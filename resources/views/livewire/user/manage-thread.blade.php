...
{{--                    </script>--}}
            ...
            <div class="uk-width-1-2@m">
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <textarea class="uk-textarea" wire:model="content" id="content" name="content" rows="6">{{ old('content') }}</textarea>
                    </div>
        ...
        <table class="uk-table uk-table-hover uk-table-divider">
            ...
            @foreach($threads as $thread)
                <tr id="row-{{ $thread->id }}">
                    ...
                    <td>
                        <span class="model-actions uk-label uk-label-warning uk-border-rounded"><a href="{{ route('Customer > Threads > Show', $thread->id) }}">نمایش</a></span>
                    </td>
                </tr>
            @endforeach
            </tbody>
